...
|---------|-------|----------|
| Quantum AI | $3.99/mo | Full AI access, Unlimited conversations, Priority support |
| Arcanum | $3.99/mo | Full knowledge library, All rituals, Astrological features |
| DeadSpeak | $3.99/mo | Full EVP suite, Unlimited sessions, Historical logs |
| Mastering the Cards | $3.99/mo | All lessons, Spread library, Daily draws |
| Etheria | $3.99/mo | Full AI companion, Emotional intelligence, Continuous learning |
