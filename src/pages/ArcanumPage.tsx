      ...
      <div className="relative z-10">
        ...
        <section ref={betaRef} className="py-16 sm:py-32 px-4 sm:px-8 bg-[#0a0a0b]/85 backdrop-blur-sm w-full">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a href="https://expo.dev/artifacts/eas/mbhx1RD7Tm6F1xxZfAXYve.apk" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-8 sm:px-12 py-4 sm:py-5 bg-[#c9a227] text-[#0a0a0b] font-cinzel text-base sm:text-lg tracking-wider rounded transition-all duration-300 hover:bg-[#f5f5f5]">
