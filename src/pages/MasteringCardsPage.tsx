...
import { Star, Moon, Eye, Sparkles, ExternalLink, Download, Mail, Bug, Gift, ChevronUp, ChevronDown } from 'lucide-react';
import { Link } from 'react-router-dom';
import LazyVideo from '../components/LazyVideo';

export default function MasteringCardsPage() {
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <div className="fixed inset-0 h-screen w-full overflow-hidden z-0">
        <LazyVideo hero src="./mastering-video.mp4" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
          <div className="text-center px-4 sm:px-8 max-w-4xl mx-auto">
            <h1 className="font-cinzel text-4xl sm:text-6xl md:text-7xl mb-4 sm:mb-6 text-[#f5f5f5] tracking-wider drop-shadow-lg">Arcanum. Tarot Academy</h1>
            ...
            <p className="text-base sm:text-lg text-[#d4d4d4] max-w-xl mx-auto leading-relaxed px-4 drop-shadow-md mb-6">The tarot is a mirror reflecting the depths of consciousness. Journey from curious novice to confident reader—guided by AI that honors the ancient art.</p>
            <div className="max-w-lg mx-auto mb-8 p-5 sm:p-6 border border-[#c9a227]/30 rounded-xl bg-gradient-to-b from-[#0f0f10]/80 to-[#0a0a0b]/80 backdrop-blur-sm">
              <h3 className="font-cinzel text-lg sm:text-xl text-center mb-4 text-[#c9a227] tracking-wider">Thank you to Arcanum. Tarot Academy's Beta Testers!</h3>
      ...
      <div className="relative z-10">
        ...
        <section className="py-16 sm:py-32 px-4 sm:px-8 bg-[#0a0a0b]/80 backdrop-blur-sm w-full">
          <div className="max-w-5xl mx-auto">
            <h2 className="font-cinzel text-3xl sm:text-4xl text-center mb-4 text-[#f5f5f5]">The Art of Cartomancy</h2>
            <p className="text-[#737373] text-center mb-12 sm:mb-20 max-w-xl mx-auto px-4">Discover what awaits on your journey to mastery</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
              {[
                { icon: Star, title: "The Major Arcana", desc: "Journey through the Fool's path—from innocence to enlightenment. Each of the 22 trump cards holds a key to universal truth." },
                { icon: Moon, title: "The Minor Mysteries", desc: "Discover the four suits—Wands, Cups, Swords, and Pentacles—and how the court cards reflect the personalities in your life." },
                { icon: Eye, title: "The Reader's Eye", desc: "Develop your intuition through guided practice readings. Learn spreads, combinations, and the art of interpretation." }
              ].map((feature, idx) => (
                <div key={idx} className="group relative p-6 sm:p-8 border border-[#262626]/70 rounded-xl bg-gradient-to-b from-[#0f0f10]/85 to-[#0a0a0b]/85 backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-[#c9a227]/50">
                  <div className="absolute inset-0 bg-[url('/mastering-bg.jpg')] opacity-5 bg-cover bg-center" />
        ...
        {/* Quote Section */}
        <section className="py-20 sm:py-32 px-4 sm:px-8 w-full" style={{ backgroundImage: 'linear-gradient(rgba(10,10,11,0.5), rgba(10,10,11,0.65)), url(/mastering-bg.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className="max-w-3xl mx-auto text-center">
            <Star className="w-8 h-8 sm:w-12 sm:h-12 text-[#c9a227]/70 mx-auto mb-6 sm:mb-10" />
            <blockquote className="font-cinzel text-xl sm:text-3xl text-[#f5f5f5]/90 italic leading-relaxed px-4 drop-shadow-md">"Every shuffle is a conversation with the universe. Every draw is a message waiting to be understood."</blockquote>
          </div>
        </section>
        ...
        <section ref={betaRef} className="py-16 sm:py-32 px-4 sm:px-8 bg-[#0a0a0b]/85 backdrop-blur-sm w-full">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-[#a3a3a3] text-base sm:text-lg mb-8 sm:mb-10 leading-relaxed px-4">Arcanum. Tarot Academy is now open for beta testing. Be among the first to experience AI-powered tarot mastery that honors the sacred traditions.</p>
            <button className="inline-flex items-center gap-3 px-8 sm:px-12 py-4 sm:py-5 bg-[#c9a227] text-[#0a0a0b] font-cinzel text-base sm:text-lg tracking-wider rounded transition-all duration-300 hover:bg-[#f5f5f5] cursor-not-allowed opacity-70">
            ...
            <div className="mt-16 text-left">
              ...
              <div className="mt-10 p-6 border border-[#c9a227]/30 rounded-xl bg-[#c9a227]/5 backdrop-blur-sm text-center">
                <p className="text-[#f5f5f5] font-cinzel text-base sm:text-lg mb-2">First 20 testers to message Etheria Systems will be granted the access codes.</p>
                <p className="text-[#a3a3a3] text-sm italic">Good luck on your spiritual journey.</p>
                <p className="text-[#c9a227] text-xs tracking-wider mt-4 font-cinzel">- Arcanum. Tarot Academy Developer</p>
              </div>
            </div>
          </div>
        </section>
