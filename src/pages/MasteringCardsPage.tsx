import { Star, Moon, Eye, Brain } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden">
      ...
      <div className="fixed inset-0 h-screen w-full overflow-hidden z-0">
        <video src="./mastering-video.mp4" autoPlay loop muted playsInline preload="auto" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
          <div className="text-center px-4 sm:px-8 max-w-4xl mx-auto">
            <h1 className="font-cinzel text-4xl sm:text-6xl md:text-7xl mb-4 sm:mb-6 text-[#f5f5f5] tracking-wider drop-shadow-lg">Mastering the Cards</h1>
      ...
      <div className="relative z-10">
        ...
        <section className="py-16 sm:py-32 px-4 sm:px-8 bg-[#0a0a0b]/85 backdrop-blur-sm w-full">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-[#a3a3a3] text-base sm:text-lg mb-8 sm:mb-10 leading-relaxed px-4">Mastering the Cards is being prepared for those called to learn the ancient art. Your journey into cartomancy begins soon.</p>
