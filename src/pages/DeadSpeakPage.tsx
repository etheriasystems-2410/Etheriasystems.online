      ...
      <div className="fixed inset-0 h-screen w-full overflow-hidden z-0">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
          <div className="text-center px-4 sm:px-8 max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg text-[#a3a3a3] max-w-xl mx-auto leading-relaxed px-4 mb-6">Across the veil that separates the living from the departed, there flows a current of wisdom and love. Create sacred space for honoring your ancestors.</p>
            <div className="max-w-lg mx-auto mb-8 p-5 sm:p-6 border border-[#c9a227]/30 rounded-xl bg-gradient-to-b from-[#0f0f10]/80 to-[#0a0a0b]/80 backdrop-blur-sm">
              <h3 className="font-cinzel text-lg sm:text-xl text-center mb-4 text-[#c9a227] tracking-wider">Thank you to Dead Speak's Beta Testers!</h3>
      ...
      <div className="relative z-10">
        ...
        <section ref={betaRef} className="py-16 sm:py-32 px-4 sm:px-8 bg-[#0a0a0b]/85 backdrop-blur-sm w-full">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-[#a3a3a3] text-base sm:text-lg mb-8 sm:mb-10 leading-relaxed px-4">Dead Speak is now open for beta testing. Be among the first to experience sacred ancestral communication that honors the traditions of old.</p>
            ...
            <div className="mt-16 text-left">
              ...
              <div className="mt-10 p-6 border border-[#c9a227]/30 rounded-xl bg-[#c9a227]/5 backdrop-blur-sm text-center">
                ...
                <p className="text-[#c9a227] text-xs tracking-wider mt-4 font-cinzel">- Dead Speak Developer</p>
              </div>
            </div>
          </div>
        </section>
