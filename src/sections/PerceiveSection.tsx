...
const PerceiveSection: React.FC = () => {
    ...
    >
      ...
      <div className="relative z-[5] w-full h-full flex flex-col items-center justify-center px-8">
        ...
        <p 
          ...
          style={{ opacity: 0 }}
        >
          Most of what is real is not visible. Etheria trains your attention to notice the subtle: impressions, patterns, and the quiet knowing beneath thought.
        </p>
      </div>
    </section>
  );
...
export default PerceiveSection;
