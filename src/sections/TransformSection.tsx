  ...
  return (
    ...
    >
      ...
      <div className="relative z-[5] w-full h-full flex flex-col items-center justify-center px-8">
        ...
        <div 
          ref={glyphRef}
          className="mb-6 text-foreground/85 animate-float"
          style={{ opacity: 0 }}
        >
          <FlameGlyph size={100} />
        </div>
        ...
        <p 
          ...
          style={{ opacity: 0 }}
        >
          Like heat refines metal, practice refines the self. Etheria offers daily rituals to transmute distraction into focus, and doubt into calm agency.
        </p>
      </div>
    </section>
  );
