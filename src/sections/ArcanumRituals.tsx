...
const ArcanumRituals: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img 
          src="/arcanum-rituals.jpg" 
          alt="Mystical ritual altar"
      ...
      <div className="relative z-[5] w-full h-full flex flex-col items-center justify-center px-8">
        ...
        <p 
          ...
          style={{ opacity: 0 }}
        >
          Step into sacred space. Arcanum Liberatus guides you through powerful rituals—ceremonies of intent, manifestation, and transformation. Light the candles, speak the words, and let the magic flow.
        </p>
      </div>
    </section>
  );
