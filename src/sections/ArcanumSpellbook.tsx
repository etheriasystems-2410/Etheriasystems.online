...
const ArcanumSpellbook: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .fromTo(glyph, 
          { opacity: 0, y: '12vh', rotate: -6 }, 
          { opacity: 1, y: 0, rotate: 0, ease: 'power2.out' }, 
          0
        )
        .fromTo(label, 
          { opacity: 0, y: '4vh' }, 
  ...
  return (
    ...
    >
      ...
      >
        <img 
          src="/arcanum-spellbook.jpg" 
          alt="Magical spellbook"
      ...
      <div className="relative z-[5] w-full h-full flex flex-col items-center justify-center px-8">
        ...
        <div 
          ref={glyphRef}
          className="mb-6 text-foreground drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)] animate-float"
          style={{ opacity: 0 }}
        >
        ...
        <p 
          ...
          style={{ opacity: 0 }}
        >
          Your personal grimoire awaits. Craft spells with Quantum AI assistance—accounting for planetary hours, moon phases, and elemental correspondences. The ancient art, made precise.
        </p>
      </div>
    </section>
  );
...
export default ArcanumSpellbook;
