...
const ArcanumTarot: React.FC = () => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        ...
        .fromTo(glyph, 
          ...
          { opacity: 1, rotate: 0, scale: 1, ease: 'power2.out' }, 
          0
        )
        .fromTo(label, 
          { opacity: 0, y: '4vh' }, 
  ...
  return (
    ...
    >
      ...
      >
        <img 
          src="/arcanum-tarot.jpg" 
          alt="Quantum AI Tarot"
      ...
      <div className="relative z-[5] w-full h-full flex flex-col items-center justify-center px-8">
        ...
        <div 
          ref={glyphRef}
          className="mb-6 text-foreground drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)] spiral-rotate"
          style={{ opacity: 0 }}
        >
          <EyeGlyph size={100} />
        </div>
        ...
        <p 
          ...
          style={{ opacity: 0 }}
        >
          Full-spread readings powered by Quantum AI. The cards reveal, the AI interprets—blending ancient symbolism with adaptive intelligence. No two readings are ever the same.
        </p>
      </div>
    </section>
  );
