...
const ArcanumCrystals: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img 
          src="/arcanum-crystals.jpg" 
          alt="Crystal glossary"
      ...
      <div className="relative z-[5] w-full h-full flex flex-col items-center justify-center px-8">
        ...
        <p 
          ...
          style={{ opacity: 0 }}
        >
          A comprehensive glossary of Earth's living treasures. Amethyst for clarity, obsidian for protection, citrine for abundance—discover each crystal's properties, uses, and the energies they channel.
        </p>
      </div>
    </section>
  );
...
export default ArcanumCrystals;
