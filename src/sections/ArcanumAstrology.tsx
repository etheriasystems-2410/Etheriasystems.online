...
const ArcanumAstrology: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        <img 
          src="/arcanum-astrology.jpg" 
          alt="Astrological charts and planetary positions"
      ...
      <div className="relative z-[5] w-full h-full flex flex-col items-center justify-center px-8">
        ...
        <p 
          ...
          style={{ opacity: 0 }}
        >
          Master the cosmic clock. Planetary hours, astrological charts, and Teutonic tides—all calculated in real-time. Know when the stars align for your rituals, spells, and divinations.
        </p>
      </div>
    </section>
  );
...
export default ArcanumAstrology;
